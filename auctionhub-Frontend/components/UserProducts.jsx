    ...
    <div className="w-full max-w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6">
        {products.map((product) => (
          <div key={product.id} className="bg-white rounded-xl shadow hover:shadow-md transition p-4 flex flex-col">
            {/* Product Image */}
      ...
      <div className="text-center mt-8">
        <button className="border border-gray-300 px-8 py-3 rounded-lg font-medium hover:bg-orange-600 hover:text-white transition-colors shadow-sm">
          See All
        </button>
      </div>
