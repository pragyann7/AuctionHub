          ...
          <div className="bg-white p-6 rounded-lg border-1 shadow-inner">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex space-x-2">
                <select className="px-3 py-2.5 text-sm rounded-l-full border border-r-0 border-gray-300 bg-white focus:ring-1 focus:ring-orange-500 focus:border-orange-500 outline-none min-w-[90px]">
