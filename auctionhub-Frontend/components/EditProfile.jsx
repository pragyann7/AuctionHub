...
export default function EditProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("profile.phone_number", formData.phone_number || "");

    if (profilePhoto) data.append("profile.profile_picture", profilePhoto);
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-6">
          ...
          <div className="sm:col-span-4">
            ...
            <div className="mt-2 flex items-center rounded-md border border-gray-300 bg-white focus-within:ring-2 focus-within:ring-indigo-600">
              <input
                type="text"
                name="username"
                id="username"
          ...
          <div className="sm:col-span-3">
            ...
            <div className="mt-2 flex items-center gap-3">
              ...
              <label className="px-3 py-2 bg-white border rounded-md shadow-sm hover:bg-gray-50 text-sm font-medium cursor-pointer">
                Change
                <input
                  type="file"
                  accept="image/*"
            ...
            <div className="mt-2 flex justify-center rounded-lg border-2 border-dashed border-gray-300 px-6 py-10">
              <div className="text-center">
                ...
                <div className="mt-4 flex text-sm text-gray-600 justify-center gap-2">
                  <label className="relative cursor-pointer rounded-md bg-white text-indigo-600 font-semibold hover:text-indigo-500">
      ...
      <div className="flex justify-end gap-4">
        <button type="button" onClick={() => navigate("/userprofile")} className="text-gray-900 font-semibold">
          Cancel
        </button>
        <button type="submit" className="bg-indigo-600 text-white px-4 py-2 rounded-md shadow hover:bg-indigo-500">
          Save
        </button>
      </div>
    </form>
