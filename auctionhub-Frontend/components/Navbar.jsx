            ...
            {isAuthenticated ? (
                <nav className="w-full px-6 py-3 border-b-[0.5px] border-gray-200 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <span className="cursor-pointer" aria-label="Profile" onClick={handleProfile}>👤</span>
                        <button
                    ...
                    {/* Mobile Menu */}
                    {menuOpen && (<div
                            className="absolute top-full left-0 w-full bg-white border-t-[0.5px] border-gray-200 flex flex-col items-center md:hidden py-4 space-y-3 shadow-lg z-50">
                            <a href="#home" className="hover:text-gray-600 transition-colors"
                               onClick={() => setMenuOpen(false)}>Home</a>
                            <a href="#auction" className="hover:text-gray-600 transition-colors"
                               onClick={() => setMenuOpen(false)}>Auction</a>
                            <a href="#browse" className="hover:text-gray-600 transition-colors"
                               onClick={() => setMenuOpen(false)}>Browse</a>
                            <a href="#mybids" className="hover:text-gray-600 transition-colors"
                               onClick={() => setMenuOpen(false)}>My Bids</a>
